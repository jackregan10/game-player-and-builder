...
/**
 * SetPositionXAction is a class that extends SetComponentValueAction and is used to set the X
 * position of the object.
 *
 * @author Christian Bepler
 */
public class SetPositionXAction extends SetComponentValueAction<Double, Transform> {
