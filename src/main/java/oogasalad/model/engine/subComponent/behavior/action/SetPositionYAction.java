...
/**
 * SetPositionYAction is a class that extends SetComponentValueAction and is used to set the Y
 * position of the object.
 *
 * @author Christian Bepler
 */
public class SetPositionYAction extends SetComponentValueAction<Double, Transform> {
